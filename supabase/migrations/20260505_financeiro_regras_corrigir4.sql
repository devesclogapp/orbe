...
-- 2. Deletar todas as regras existentes
DELETE FROM public.financeiro_regras;

-- 3. Inserir as 5 regras padronizadas INCLUINDO colunas 'tipo' e 'vinculo'
INSERT INTO public.financeiro_regras (nome, tipo, vinculo, modalidade_financeira, prazo_dias, tipo_liquidacao, gera_conta_receber, entra_caixa_imediato, agrupa_faturamento, formas_pagamento_permitidas, ativo)
VALUES
(
