...
-- 3. Inserir as 5 regras padronizadas INCLUINDO a coluna 'tipo'
INSERT INTO public.financeiro_regras (nome, tipo, modalidade_financeira, prazo_dias, tipo_liquidacao, gera_conta_receber, entra_caixa_imediato, agrupa_faturamento, formas_pagamento_permitidas, ativo)
VALUES
(
