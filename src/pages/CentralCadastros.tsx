...
const inferModeloCalculo = (tipoColaborador?: string, tipoContrato?: string) => {
  const tipo = String(tipoColaborador || "").toUpperCase();
                        ...
                        <div className="p-6 border-t border-border/50 bg-muted/20 flex justify-end gap-3 mt-auto sticky top-[100vh]">
                          ...
                          <Button onClick={() => {
                            setEditingColaborador({
                              ...selectedColaboradorDrawer,
                              regime_trabalho: selectedColaboradorDrawer.regime_trabalho || inferRegimeTrabalho(selectedColaboradorDrawer.tipo_colaborador),
                              modelo_calculo: selectedColaboradorDrawer.modelo_calculo || inferModeloCalculo(selectedColaboradorDrawer.tipo_colaborador, selectedColaboradorDrawer.tipo_contrato),
            ...
            {colaboradorStep === 2 && (
              <div className="grid grid-cols-2 gap-4 py-2">
                  ...
                  <Select
                    ...
                    onValueChange={(v) =>
                      setColaboradorForm({
                        ...colaboradorForm,
                        tipo_colaborador: v,
                        regime_trabalho: inferRegimeTrabalho(v),
                        modelo_calculo: inferModeloCalculo(v, colaboradorForm.tipo_contrato),
                        permitir_lancamento_operacional: ["DIARISTA", "INTERMITENTE", "PRODUÇÃO", "PRODUCAO", "TERCEIRIZADO"].includes(v),
                      })
                    }
                  >
                ...
                <div className="space-y-1.5">
                  ...
                  <Select value={colaboradorForm.regime_trabalho} onValueChange={(v) => setColaboradorForm({ ...colaboradorForm, regime_trabalho: v })}>
                    <SelectTrigger><SelectValue /></SelectTrigger>
                    <SelectContent>
                      <SelectItem value="CLT">CLT</SelectItem>
                      <SelectItem value="Intermitente">Intermitente</SelectItem>
                ...
                {colaboradorForm.modelo_calculo === "Horista" && (
                  <>
                    <div className="space-y-1.5">
                      <Label>Valor hora (R$) <span className="text-destructive">*</span></Label>
                    ...
                    <div className="space-y-1.5">
                      <Label>Estimativa mensal</Label>
                      <Input type="number" value={colaboradorForm.estimativa_mensal} onChange={(e) => setColaboradorForm({ ...colaboradorForm, estimativa_mensal: e.target.value })} />
                    </div>
                  </>
                )}
                ...
                {colaboradorForm.modelo_calculo === "Produção" && (
                  <>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <Input value={colaboradorForm.regra_operacional} onChange={(e) => setColaboradorForm({ ...colaboradorForm, regra_operacional: e.target.value })} />
                    </div>
                  </>
                )}
