                                ...
                                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex items-center gap-4 pt-2">
                                            ...
                                            <button className="text-xs font-bold text-info flex items-center gap-1">
                                    ...
                                    <div className="bg-gray-50 p-6 rounded-2xl text-center min-w-[180px] border border-gray-100">
                                        <span className="text-[10px] text-muted-foreground font-bold uppercase tracking-widest block mb-1">Valor Total</span>
                        ...
                        <div className="space-y-6">
                            {[1, 2].map((i) => (
                                <div key={i} className="flex gap-4 relative">
                                    {i === 1 && <div className="absolute left-[7px] top-4 bottom-[-24px] w-0.5 bg-gray-100"></div>}
                                    <div className={`w-4 h-4 rounded-full mt-1.5 shrink-0 z-10 ${i === 1 ? 'bg-success shadow-[0_0_0_4px_rgba(34,197,94,0.1)]' : 'bg-success'}`}></div>
                                    <div>
                                        <p className="text-xs font-bold text-gray-900">Fechamento Março/2024</p>
                                        <p className="text-[10px] text-muted-foreground">Aprovado em 05/04/2024 por João Silva</p>
                                    </div>
                                </div>
                            ))}
                        </div>
