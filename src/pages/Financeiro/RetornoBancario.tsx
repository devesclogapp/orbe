...
import { ConciliacaoReceitasBlock } from "./components/ConciliacaoReceitasBlock";
    ...
    <AppShell title="Central de Conciliações">
      <div className="mx-auto max-w-[1700px] w-full px-4 sm:px-6 md:px-8">
        <Tabs defaultValue="pagamentos">
          ...
          <TabsContent value="pagamentos" className="space-y-6 m-0 animate-in fade-in-50 duration-500">
