...
const routeMeta: RouteMeta[] = [
  ...
  { pattern: "/financeiro/remessa/historico", label: "Historico de remessas", section: "Pagamentos e Remessas", parentPath: "/bancario" },
  { pattern: "/processamento/legado", label: "Processamento (legado)", section: "Operacional" },
  ...
  { pattern: "/financeiro/remessa", label: "Remessa CNAB240", section: "Pagamentos e Remessas", parentPath: "/bancario" },
  { pattern: "/financeiro/retorno", label: "Retorno bancario", section: "Pagamentos e Remessas", parentPath: "/bancario" },
  ...
  { pattern: "/bancario", label: "Pagamentos e Remessas", section: "Pagamentos e Remessas" },
