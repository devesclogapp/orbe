...
const routeMeta: RouteMeta[] = [
  ...
  { pattern: "/processamento/legado", label: "Processamento legado", section: "Operacional", parentPath: "/operacional/operacoes" },
  ...
  { pattern: "/producao", label: "Producao in-loco", section: "Operacional", parentPath: "/operacional/operacoes" },
